package com.personagen.views.datosbancarios;
...
@Route(value = "datosbancarios", layout = MainLayout.class)
public class DatosbancariosView extends Div {
    ...
    public DatosbancariosView() {
        addClassName("datosbancarios-view");
