package com.personagen.views.direccion;

import com.personagen.data.entity.SampleAddress;
import com.personagen.data.service.SampleAddressService;
import com.personagen.views.MainLayout;
...
public class DireccionView extends Div {
    ...
    public DireccionView(SampleAddressService addressService) {
        addClassName("direccion-view");
